...
namespace CourseStore.Infra.Dal.Migrations
{
    ...
    [Migration("20201231080831_RootObject")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseStore.Core.Domain.Relation01", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Relation01");
                });

            modelBuilder.Entity("CourseStore.Core.Domain.Relation02", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Relation02");
                });

            modelBuilder.Entity("CourseStore.Core.Domain.Relation03", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Relation03");
                });

            modelBuilder.Entity("CourseStore.Core.Domain.RootObject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CourseStore.Core.Domain.Relation01", b =>
                {
                    b.HasOne("CourseStore.Core.Domain.RootObject", null)
                        .WithMany("Relation01s")
            ...
            modelBuilder.Entity("CourseStore.Core.Domain.RootObject", b =>
                {
                    b.Navigation("Relation01s");

                    b.Navigation("Relation02s");

                    b.Navigation("Relation03s");
                });
